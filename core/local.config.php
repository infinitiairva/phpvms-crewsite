...
define('DBASE_USER', 'infinitiairva');
define('DBASE_PASS', '1152017infiniti');
define('DBASE_NAME', 'infinitiairva');
define('DBASE_SERVER', 'mysql.infinitiairva.com');
define('DBASE_TYPE', 'mysqli');

define('TABLE_PREFIX', 'phpvms_');

define('SITE_URL', 'https://crew.infinitiairva.com');
...
Config::Set('MAP_CENTER_LAT', '39.739236');
Config::Set('MAP_CENTER_LNG', '-104.990251');
...
# Email Settings
Config::Set('EMAIL_FROM_NAME', 'Infinitiairva');
Config::Set('EMAIL_FROM_ADDRESS', 'admin@infinitiairva.com');

Config::Set('EMAIL_USE_SMTP', true);
# Add multiple SMTP servers by separating them with ;
Config::Set('EMAIL_SMTP_SERVERS', 'sub5.mail.dreamhost.com');
...
Config::Set('EMAIL_SMTP_USER', 'admin@infinitiairva.com');
Config::Set('EMAIL_SMTP_PASS', '1111111a');

// Google Recaptcha
Config::Set('RECAPTCHA_PUBLIC_KEY', '6LekvDwUAAAAAAQa3ij55bfeqT7ibtSSls6Cwyi0');
Config::Set('RECAPTCHA_PRIVATE_KEY', '6LekvDwUAAAAABWTNxm4KB9MtPmDbe2wZlhRzHLY');
